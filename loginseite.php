        ...
        <div class="card" style="width: 400px;">
            ...
            <div class="card-body">
                ...
                <div class="mt-3 text-center">
                    <a href="registerseite.php">Noch keinen Account?</a>
                </div>
            </div>
            <?php
                if(isset($_GET['passwort'])){
                    echo "<p class='alert alert-danger'>Passwort ist falsch!</p>";
                }
                if(isset($_GET['benutzer'])){
                    echo "<p class='alert alert-danger'>Benutzer ist falsch!</p>";
                }
            ?>
        </div>
    </div>
